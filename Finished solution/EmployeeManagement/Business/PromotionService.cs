    ...
    IEmployeeManagementRepository employeeManagementRepository) : IPromotionService
{
    ...
    private readonly IEmployeeManagementRepository _employeeManagementRepository = employeeManagementRepository;
        ...
        Guid employeeId)
    {
        ...
        // return value
        return promotionEligibility != null && promotionEligibility.EligibleForPromotion;
    }
}